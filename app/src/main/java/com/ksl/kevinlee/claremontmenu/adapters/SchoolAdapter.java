...
import com.ksl.kevinlee.claremontmenu.screen.SchoolFragment;

import java.text.SimpleDateFormat;
import java.util.Date;

import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.BREAKFAST;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.BRUNCH;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.CMC;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.DINNER;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.FRANK;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.FRARY;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.HOURS_KEY;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.LUNCH;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.MUDD;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.OLDENBORG;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.PITZER;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.SCRIPPS;
import static com.ksl.kevinlee.claremontmenu.data.network.DBConfig.isWeekend;
